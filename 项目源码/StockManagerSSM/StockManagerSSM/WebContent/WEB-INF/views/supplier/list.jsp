...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                <td width="60" align="right">供应商联系人:</td>
                <td><input type="text" name="contactName" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写供应商联系人'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">联系人手机:</td>
                <td><input type="text" name="contactPhone" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写供应商联系人手机号'" /></td>
            </tr>
            <tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
            ...
            <tr>
                <td width="60" align="right">供应商联系人:</td>
                <td><input type="text" id="edit-contactName" name="contactName" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写供应商联系人'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">联系人手机:</td>
                <td><input type="text" id="edit-contactPhone" name="contactPhone" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写供应商联系人手机号'" /></td>
            </tr>
            <tr>
                <td width="60" align="right">供应商地址:</td>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'contactPhone',title:'联系人手机号',width:100,sortable:true},
